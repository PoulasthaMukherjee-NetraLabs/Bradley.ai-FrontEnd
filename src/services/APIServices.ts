import {
  ORGANIZATION_DATA,
  ADDRESS_DATA,
  ENERGY_INTERVAL_DATA,
  THERMAL_ENERGY_NEEDS_I_DATA,
  THERMAL_ENERGY_NEEDS_II_DATA,
  THERMAL_ENERGY_NEEDS_III_DATA,
  THERMAL_ENERGY_NEEDS_IV_DATA,
  EXISTING_BOILER_COGENERATION_DATA,
} from "./Constants";
...
const getFriendlyErrorMessage = (
  error: any,
  specialCodes: { [key: number]: string } = {},
): string => {
...
// Facility Address
export const updateFacilityAddresses = async (
  data: AddressPayload[],
...
// Bill Upload
export const uploadBillData = async (
  Files: File[],
  sources: string[],
  uuids: string[],
...
export const addThermalEnergyNeedsI = async (
  data: ThermalEnergyNeedsI,
  file_id: string,
): Promise<boolean> => {
  try {
    ...
    const friendlyMessage = getFriendlyErrorMessage(error);
    console.error(
      "Error adding Thermal Energy Needs I data:",
      friendlyMessage,
      error,
    );
    return false;
...
export const addThermalEnergyNeedsII = async (
  data: ThermalEnergyNeedsII,
  file_id: string,
): Promise<boolean> => {
  try {
    const payload = { ...data, file_id };
    ...
    const friendlyMessage = getFriendlyErrorMessage(error);
    console.error(
      "Error adding Thermal Energy Needs II data:",
      friendlyMessage,
      error,
    );
    return false;
...
export const addThermalEnergyNeedsIII = async (
  data: ThermalEnergyNeedsIII,
  file_id: string,
): Promise<boolean> => {
  try {
    const payload = { ...data, file_id };
    ...
    const friendlyMessage = getFriendlyErrorMessage(error);
    console.error(
      "Error adding Thermal Energy Needs III data:",
      friendlyMessage,
      error,
    );
    return false;
...
export const addThermalEnergyNeedsIV = async (
  data: ThermalEnergyNeedsIV,
  file_id: string,
): Promise<boolean> => {
  try {
    const payload = { ...data, file_id };
    ...
    const friendlyMessage = getFriendlyErrorMessage(error);
    console.error(
      "Error adding Thermal Energy Needs IV data:",
      friendlyMessage,
      error,
    );
    return false;
...
export const addExistingBoilerCogeneration = async (
  data: ExistingBoilerCogeneration,
  file_id: string,
): Promise<boolean> => {
  try {
    const payload = { ...data, file_id };
    ...
    const friendlyMessage = getFriendlyErrorMessage(error);
    console.error(
      "Error adding Existing Boiler Cogeneration data:",
      friendlyMessage,
      error,
    );
    return false;
