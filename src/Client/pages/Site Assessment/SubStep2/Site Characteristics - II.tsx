        ...
        <Box sx={{ width: '100%', display: 'flex', flexDirection: 'column', gap: 2, pt: '10px', pb: '10px', pl: '160px', pr: '160px' }}>
          <Box sx={{ display: 'flex', flexDirection: 'column', mt: 1 }}>
            <Box sx={{ mt: 1, display: 'flex', alignItems: 'center', gap: 10 }}>
              <Typography sx={{ fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.75rem', flex: 0.685 }}><b>Humidification Issues?</b></Typography>
              <FormControl sx={{ flex: 0.5, minWidth: 120 }}>
                <Select value={humidification} onChange={(e) => handleSelectChange(e, 'humidification')} displayEmpty size="small" sx={{ fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.7rem', height: '40px' }}>
            ...
            <Box sx={{ mt: 1, display: 'flex', alignItems: 'center', gap: 10 }}>
              <Typography sx={{ fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.75rem', flex: 0.685 }}><b>Hot / Cold Spots?</b></Typography>
              <FormControl sx={{ flex: 0.5, minWidth: 120 }}>
                <Select value={hotColdSpots} onChange={(e) => handleSelectChange(e, 'hotColdSpots')} displayEmpty size="small" sx={{ fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.7rem', height: '40px' }}>
                  <MenuItem disabled value="" sx={{ fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.7rem' }}>Select Yes or No</MenuItem>
                  <MenuItem value="yes" sx={{ fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.7rem' }}>Yes</MenuItem>
                  <MenuItem value="no" sx={{ fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.7rem' }}>No</MenuItem>
                </Select>
            ...
            <Box sx={{ mt: 1, display: 'flex', alignItems: 'center', gap: 10 }}>
              <Typography sx={{ fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.75rem', flex: 0.685 }}><b>Outdoor Air Supply Issues?</b></Typography>
              <FormControl sx={{ flex: 0.5, minWidth: 120 }}>
                <Select value={outdoorAirSupply} onChange={(e) => handleSelectChange(e, 'outdoorAirSupply')} displayEmpty size="small" sx={{ fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.7rem', height: '40px' }}>
                  <MenuItem disabled value="" sx={{ fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.7rem' }}>Select Yes or No</MenuItem>
                  <MenuItem value="yes" sx={{ fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.7rem' }}>Yes</MenuItem>
                  <MenuItem value="no" sx={{ fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.7rem' }}>No</MenuItem>
                </Select>
            ...
            <Box sx={{ mt: 1, display: 'flex', alignItems: 'center', gap: 10 }}>
              <Typography sx={{ fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.75rem', flex: 0.685 }}><b>Number of 8-hour Shifts Per Day:</b> (Max 3)</Typography>
              <TextField variant="outlined" size="small" type="text" placeholder="Input (Max 3)" value={shifts} onChange={handleShiftsChange} sx={{ flex: 0.5, fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.7rem', '& .MuiInputBase-root': { height: '40px' }, '& .MuiInputBase-input::placeholder': { fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.7rem' } }} />
            </Box>
            <Box sx={{ mt: 1, display: 'flex', alignItems: 'center', gap: 10 }}>
              <Typography sx={{ fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.75rem', flex: 0.685 }}><b>HVAC System Operation:</b> <span style={{ fontWeight: 'normal' }}>(Pick One)</span></Typography>
              <Box sx={{ flex: 0.5, minWidth: 120, display: 'flex', flexDirection: 'column' }}>
                <FormControl>
                  <Select value={hvacOperation} onChange={(e) => handleSelectChange(e, 'hvacOperation')} displayEmpty size="small" sx={{ fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.7rem', height: '40px' }}>
