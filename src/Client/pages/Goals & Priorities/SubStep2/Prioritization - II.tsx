...
import { usePrioritizationII } from '../../../../Context/Goals & Priorities/SubStep2/Prioritization - II Context';
...
const SubStep2: React.FC = () => {
  ...
  const handleSliderChange = (field: 'resiliencyIncrease' | 'scope2Reduction' | 'costReduction', value: number | number[]) => {
    ...
    <Box sx={{ display: 'flex', flexDirection: 'column', fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.75rem', p: 1, pr: 4, pl: 1, pt: 1 }}>
      ...
      <Box sx={{ display: 'flex', justifyContent: 'space-between', gap: 0 }}>
        <Box sx={{ width: '100%', display: 'flex', flexDirection: 'column', gap: 2, p: '10px' }}>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, justifyContent: 'center' }}>
            <Typography sx={{ fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.75rem', flex: 0.307 }}><b>Decarbonization Target:</b></Typography>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, justifyContent: 'center' }}>
            <Typography sx={{ fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.75rem', flex: 0.307 }}><b>Energy Savings Target:</b></Typography>
            ...
            <Select size="small" variant="outlined" value={energySavingsTarget.unit} onChange={(e: SelectChangeEvent) => updateTargetField('energySavingsTarget', 'unit', e.target.value)} sx={{ flex: 0.07, fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.7rem', height: '40px', '& .MuiInputBase-root': { padding: '0 6px' }, '& .MuiSelect-select': { padding: '4px 6px', fontSize: '0.7rem' } }}>
              <MenuItem value="%" sx={{ fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.7rem' }}>%</MenuItem>
              <MenuItem value="kWh" sx={{ fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.7rem' }}>kWh</MenuItem>
              <MenuItem value="days" sx={{ fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.7rem' }}>days</MenuItem>
            </Select>
